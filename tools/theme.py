...
# 이 저장소는 화면 갈래가 파일 이름으로 안 갈린다(OMR·문제지·해설지가
# 회차 이름으로 붙는다). 그래서 한 갈래로 두고 표식만 통일한다.
FAMILY = ()
...
TOKENS = """--ink:#1C1812;--ink-2:#403A30;--ink-soft:#2A241B;--muted:#6E6556;--grey:#9A917F;
  --line:#E6DECF;--line-2:#D6CAB3;
  --paper:#F4EFE6;--paper-2:#FBF8F1;--paper-3:#EFE7D6;
  --teal:#0E7A6E;--teal-d:#0A5C53;
  --gold:#A07E2B;--gold-2:#C9A24B;--gold-deep:#7A5E1C;
  --amber:#BD7A12;--emerald:#2E7D5B;--cobalt:#2A5470;--rose:#B23A6B"""
...
SEAL = (
    ...
    " viewBox='0 0 520 560'%3E%3Cg fill='none' stroke='%230E7A6E' stroke-width='9'"
    ...
    "%3Cg fill='%230E7A6E' opacity='0.05'%3E"

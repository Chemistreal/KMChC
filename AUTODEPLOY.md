...
설정을 마치면 **AppsScript_GitHub빠른조회_정리본.gs가 main에 머지될 때마다 자동으로 Apps Script에 반영되고
...
## 4. 끝. 확인 방법
- 이후 AppsScript_GitHub빠른조회_정리본.gs가 main에 머지되면 **Actions 탭**에 "Apps Script 자동 배포"가 돌고,
